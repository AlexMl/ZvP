 ...
 * 
 * Credit to desht as the author of the dhutils https://github.com/desht/dhutils
 */
//@formatter:on
public class ExperienceManager {
    ...
    /**
     * Calculate the level that the given XP quantity corresponds to, without using the lookup tables. This is needed if getLevelForExp() is called with an XP quantity beyond the range of the existing
     * lookup tables.
     * 
     * @param exp
     * @return
     ...
     * @throws IllegalArgumentException
     *         if the level is less than 0 or greater than the current hard maximum
     */
