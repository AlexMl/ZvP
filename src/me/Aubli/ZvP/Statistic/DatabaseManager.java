...
public class DatabaseManager implements DatabaseCallback {
	...
	try {
	    ...
	    ZvP.getPluginLogger().log(getClass(), Level.SEVERE, "Can not initialize connection. SQL error:", true, false, e);
	} catch (ClassNotFoundException e) {
	    ZvP.getPluginLogger().log(getClass(), Level.SEVERE, "Can not initialize connection with " + this.db_info.getProtocol() + "! Not supported implementation!", true, false, e);
	}
    }
