...
public class ShopManager {
	...
	private void writeDefaults() {
		...
		ShopItem[] defaultItems = new ShopItem[33];
		...
		defaultItems[9] = new ShopItem(item, cat, 4.5);
		
		
		//Misc
		cat = ItemCategory.MISC;
		item = new ItemStack(Material.STICK);
		defaultItems[10] = new ShopItem(item, cat, 1.0);
		item = new ItemStack(Material.EXP_BOTTLE);
		defaultItems[11] = new ShopItem(item, cat, 7.5);
		item = new ItemStack(Material.LEATHER);
		defaultItems[12] = new ShopItem(item, cat, 2.0);
		...
		defaultItems[20] = new ShopItem(item, cat, 5.5);
		item = new ItemStack(Material.IRON_LEGGINGS);
		defaultItems[21] = new ShopItem(item, cat, 5.0);
		item = new ItemStack(Material.IRON_BOOTS);
		defaultItems[22] = new ShopItem(item, cat, 3.0);
		...
		defaultItems[25] = new ShopItem(item, cat, 4.5);
		...
		defaultItems[28] = new ShopItem(item, cat, 10.0);
		item = new ItemStack(Material.IRON_AXE);
		defaultItems[29] = new ShopItem(item, cat, 5.0);
		item = new ItemStack(Material.IRON_SWORD);
		defaultItems[29] = new ShopItem(item, cat, 6.0);
		item = new ItemStack(Material.GOLD_SWORD);
		defaultItems[30] = new ShopItem(item, cat, 4.0);
		item = new ItemStack(Material.WOOD_SWORD);
		defaultItems[31] = new ShopItem(item, cat, 2.0);		
