...
public class GermanTranslation extends ListResourceBundle {
    ...
    private Object[][] contents = {
	    ...
	    {"manage:position_saved_poly", ChatColor.GREEN + "Position " + ChatColor.GOLD + "%s" + ChatColor.GREEN + " aufgenommen! Benutze " + ChatColor.DARK_PURPLE + "'/zvp add arena clear'" + ChatColor.GREEN + " um die Positionsliste zu löschen! Bemutze " + ChatColor.DARK_PURPLE + "'/zvp add arena finish'" + ChatColor.GREEN + " um abzuschließen!"},
	    {"manage:position_cleared", ChatColor.GREEN + "Positionen wurden zurückgesetzt! Du kannst neu beginnen!"},
	    ...
	    {"manage:tool", ChatColor.DARK_PURPLE + "Benutze das Tool um Positionen für eine Arena zu erstellen."},
	    {"manage:lobby_saved", ChatColor.GREEN + "Lobby gespeichert!"},
	    {"manage:arena_saved", ChatColor.GREEN + "Arena " + ChatColor.GOLD + "%s"+ ChatColor.GREEN + " gespeichert!"},
