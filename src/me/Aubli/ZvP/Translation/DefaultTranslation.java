...
public class DefaultTranslation extends ListResourceBundle {
    ...
    private Object[][] contents = {
	    ...
	    {"manage:position_saved_poly", ChatColor.GREEN + "Position " + ChatColor.GOLD + "%s" + ChatColor.GREEN + " saved! Use " + ChatColor.DARK_PURPLE + "'/zvp add arena clear'" + ChatColor.GREEN + " to clear the list! Use " + ChatColor.DARK_PURPLE + "'/zvp add arena finish'" + ChatColor.GREEN + " to finish editing!"},
	    {"manage:position_cleared", ChatColor.GREEN + "Positions are reseted! You can start again!"},
	    ...
	    {"manage:tool", ChatColor.DARK_PURPLE + "Use this tool to create positions for an arena!"},
